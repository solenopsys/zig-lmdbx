...
pub const struct_MDBX_version_info = extern struct {
    major: u16 = @import("std").mem.zeroes(u16),
    minor: u16 = @import("std").mem.zeroes(u16),
    patch: u16 = @import("std").mem.zeroes(u16),
    tweak: u16 = @import("std").mem.zeroes(u16),
    semver_prerelease: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
        ...
        _ = blk: {
            ...
            break :blk blk_1: {
                break :blk_1 if (proxy <= @as(c_ulong, 18446744073709551615)) {} else {
                    __assert_fail("proxy <= SIZE_MAX", "/home/alexstorm/distrib/4ir/ZIG/lmdbx/libs/libmdbx/mdbx.h", @as(c_uint, @bitCast(@as(c_int, 3012))), "int mdbx_env_get_syncbytes(const MDBX_env *, size_t *)");
                };
            };
        };
        ...
        _ = blk: {
            ...
            break :blk blk_1: {
                break :blk_1 if (proxy <= @as(u64, @bitCast(@as(c_ulong, @as(c_uint, 4294967295))))) {} else {
                    __assert_fail("proxy <= UINT32_MAX", "/home/alexstorm/distrib/4ir/ZIG/lmdbx/libs/libmdbx/mdbx.h", @as(c_uint, @bitCast(@as(c_int, 3075))), "int mdbx_env_get_syncperiod(const MDBX_env *, unsigned int *)");
                };
            };
        };
...
const struct_unnamed_21 = extern struct {
    ...
    volume: u64 = @import("std").mem.zeroes(u64),
    calls: u32 = @import("std").mem.zeroes(u32),
};
...
pub const struct_MDBX_chk_scope = extern struct {
    ...
    internal: ?*struct_MDBX_chk_internal_22 = @import("std").mem.zeroes(?*struct_MDBX_chk_internal_22),
...
pub const struct_MDBX_chk_histogram = extern struct {
    ...
    ranges: [9]struct_unnamed_27 = @import("std").mem.zeroes([9]struct_unnamed_27),
};
const struct_unnamed_26 = extern struct {
    ...
    tree_filling: struct_MDBX_chk_histogram = @import("std").mem.zeroes(struct_MDBX_chk_histogram),
    nested_tree_filling: struct_MDBX_chk_histogram = @import("std").mem.zeroes(struct_MDBX_chk_histogram),
};
pub const struct_MDBX_chk_table = extern struct {
    ...
    pages: struct_unnamed_25 = @import("std").mem.zeroes(struct_unnamed_25),
    histogram: struct_unnamed_26 = @import("std").mem.zeroes(struct_unnamed_26),
};
...
// /home/alexstorm/distrib/4ir/ZIG/lmdbx/libs/libmdbx/mdbx.h:226:9
pub const MDBX_PURE_FUNCTION = @compileError("unable to translate macro: undefined identifier `__pure__`");
// /home/alexstorm/distrib/4ir/ZIG/lmdbx/libs/libmdbx/mdbx.h:250:9
pub const MDBX_NOTHROW_PURE_FUNCTION = @compileError("unable to translate macro: undefined identifier `__pure__`");
// /home/alexstorm/distrib/4ir/ZIG/lmdbx/libs/libmdbx/mdbx.h:267:9
pub const MDBX_CONST_FUNCTION = @compileError("unable to translate C expr: unexpected token '__attribute__'");
// /home/alexstorm/distrib/4ir/ZIG/lmdbx/libs/libmdbx/mdbx.h:291:9
pub const MDBX_NOTHROW_CONST_FUNCTION = @compileError("unable to translate macro: undefined identifier `__nothrow__`");
// /home/alexstorm/distrib/4ir/ZIG/lmdbx/libs/libmdbx/mdbx.h:308:9
pub const MDBX_DEPRECATED = @compileError("unable to translate macro: undefined identifier `__deprecated__`");
// /home/alexstorm/distrib/4ir/ZIG/lmdbx/libs/libmdbx/mdbx.h:328:9
...
// /home/alexstorm/distrib/4ir/ZIG/lmdbx/libs/libmdbx/mdbx.h:2702:9
